...
1. Write the JSON schema describing your resource, [stacktape-ecsbluegreenv1-service.json](./stacktape-ecsbluegreenv1-service.json)
2. Implement your resource handlers in [handlers.ts](./stacktape-ecsbluegreenv1-service/handlers.ts)

> Don't modify [models.ts](./stacktape-ecsbluegreenv1-service/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
